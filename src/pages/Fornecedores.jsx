    ...
    <div style={{ padding:'1.25rem 1.5rem' }}>
          ...
          <form onSubmit={salvar}>
            ...
            <div style={{ display:'flex', gap:8 }}>
              <button type="submit" disabled={salvando} style={s.btn(salvando?'#D3D1C7':VERDE)}>
                {salvando ? 'Salvando...' : editando ? '<i className="ti ti-device-floppy" style={{marginRight:4}} /> Salvar alterações' : '+ Cadastrar fornecedor'}
              </button>
      ...
      {listaFiltrada.length === 0 ? (
        <div style={{ ...s.card, textAlign:'center', padding:'2.5rem', color:'#888780' }}>
          <div style={{ fontSize:28, marginBottom:8 }}><i className="ti ti-store" style={{fontSize:14}} /></div>
