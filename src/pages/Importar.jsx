    ...
    <div style={{ padding: '1.25rem 1.5rem' }}>
      ...
      {step === 1 && (
        <div style={s.card}>
          ...
          <label style={{ display: 'block', border: '1.5px dashed #D3D1C7', borderRadius: 12, padding: '2.5rem', textAlign: 'center', cursor: 'pointer', color: '#888780', fontSize: 13, transition: 'border-color .2s' }}>
        ...
        <>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 10, marginBottom: '1.25rem' }}>
            {[
              ...
              { label: 'Saídas', val: movs.filter(m => m.tipo === 'saida').length + ' movs', cor: '#E8212A' },
            ].map(m => (
                ...
                <tbody>
                  {movs.map((m, i) => (
                    <tr key={i} style={{ background: i % 2 === 0 ? '#fff' : '#FAFAF8' }}>
                      ...
                      <td style={{ ...s.td, fontWeight: 500, color: m.tipo === 'entrada' ? VERDE : '#E8212A', whiteSpace: 'nowrap' }}>
