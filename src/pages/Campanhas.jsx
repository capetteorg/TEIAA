...
import { gerarPDFCampanha } from '../lib/pdfLazy'
...
export default function Campanhas() {
    ...
    return (
      <div style={{ padding: '1.25rem 1.5rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: '1.25rem' }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.022em' }}>{campanhaSel.nome}</div>
  ...
  return (
    <div style={{ padding: '1.25rem 1.5rem' }}>
      <div style={{ fontSize: 22, fontWeight: 700, letterSpacing: '-0.022em', marginBottom: '1.25rem' }}>Campanhas</div>
