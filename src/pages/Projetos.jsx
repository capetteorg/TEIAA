...
export default function Projetos() {
  ...
  const s = {
    ...
    tab: ativo => ({ padding:'6px 14px', fontSize:12, borderRadius:8, border:`0.5px solid ${ativo?'#0E7EA8':'#D3D1C7'}`, background:ativo?'#0E7EA8':'#fff', color:ativo?'#fff':'#5F5E5A', cursor:'pointer' }),
    ...
    secao: cor => ({ fontSize:11, fontWeight:600, color:cor||'#0E7EA8', borderLeft:`3px solid ${cor||'#0E7EA8'}`, paddingLeft:8, margin:'16px 0 8px', textTransform:'uppercase', letterSpacing:'.05em' }),
              ...
              return (
                <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(150px,1fr))', gap:10, marginBottom:10 }}>
                  {[
                    ...
                    <div key={l} style={{ background:'rgba(255,255,255,0.92)', border:'0.5px solid #E8E6DE', borderRadius:14, boxShadow:'0 1px 8px rgba(0,0,0,0.04)', padding:'.85rem 1rem' }}>
